# Operator Quickstart — Community Last-Mile Courier

Shortest path from clone to a verified local dry-run for **ISIC 5320** (`cloud-itonami-isic-5320`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-5320.git
cd cloud-itonami-isic-5320
```
...
- Blueprint governor key: `courier-governor`
- Likely source path: `courierops.governor.cljc`
